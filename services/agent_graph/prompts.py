...
■ 任务类型简要说明：
  ...
  - 挑战：要求玩家高难度通关（修罗/地狱难度），基础奖励×2，经验占比≥50%。
  - 切磋：要求玩家通关当前NPC的切磋关卡或副本（需NPC有此能力）。
  - 资源收集：让玩家收集一些食材/药剂/材料/弹夹并提交给NPC，奖励额外+提交品价值的1~2倍。
  - 装备缴纳/特殊物品获取：让玩家获取1件装备或1件特殊物品并提交给NPC，奖励额外+提交品价值的1~2倍。
  - 物品持有：让玩家只需取得物品/情报，而非提交，奖励额外+持有品价值的0.5倍。
  - 通关并收集：让玩家前往已确认拥有物品的某关卡/某区域并从中搜刮/收集/获取关卡中的装备/资源并提交给NPC，基础奖励×2并叠加上述提交品价值加成。
  - 通关并持有：让玩家前往已确认拥有物品的某关卡/某区域并从中寻找/确认/取得关卡中的物品/情报，但无需提交，基础奖励×2并叠加上述持有品价值加成。
